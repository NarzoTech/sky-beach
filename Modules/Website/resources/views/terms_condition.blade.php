...
@section('title', 'terms_condition - CTAKE')
                    ...
                    <div class="row wow fadeInUp">
                        <div class="col-12">
                            <div class="privacy_policy_text">
                                ...
                                <p>Are may share your information with trusted service providers to facilitate our
                                    services. We
                                    ensure that these partners maintain the same level of data protection and
                                ...
                                <p>We may share your information with trusted service providers to facilitate our
                                    ...
                                    providers to facilitate our services.</p>
                                <ul>
                                    <li>The implement industry-standard security measures to protect your information.
                                    </li>
                                    <li>Out of marketing communications, and request the deletion of your data. </li>
                                    <li>Please contact us to exercise these rights.</li>
                                    <li>If you have any questions or concerns about our Privacy Policy.</li>
                                    <li>To Cancellation and Rescheduling</li>
                                    <li>To Feedback and Reviews</li>
                                </ul>
                                <h4>Your Choices</h4>
                                ...
                                <p>If you have any questions or concerns about our Privacy Policy or data practices,
                                    please
                                    contact us at</p>
                                <a href="mailto:Email:supportCTAKE@gmail.com">Email: supportCTAKE@gmail.com</a>
