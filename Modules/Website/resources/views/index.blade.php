...
@section('content')
    @if (!$hero || $hero->section_status)
        ...
        <section class="banner"
            style="background: url({{ $hero && $hero->background_image ? asset($hero->background_image) : asset('website/images/banner_bg.jpg') }});">
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-xxl-6 col-lg-6 col-xl-6 col-md-9">
                        <div class="banner_text">
                            <h5 class="wow fadeInRightBig" data-wow-duration="1.5s">{{ $hero->subtitle ?? 'Delicious Food' }}
                            </h5>
                            <h1 class="wow fadeInLeftBig" data-wow-duration="1.5s">
                                {{ $hero->title ?? 'Special Foods for your Eating' }}</h1>
                            <p class="wow fadeInRightBig" data-wow-duration="1.5s">
                                {{ $hero->description ?? 'Experience the finest culinary delights crafted with passion and served with love.' }}
                            </p>
                            <a class="common_btn wow fadeInUpBig"
                                href="{{ $hero->button_link ?? route('website.menu') }}">{{ $hero->button_text ?? 'Order Now' }}</a>
                        </div>
                    </div>
                    <div class="col-xxl-5 col-lg-6 col-xl-6">
                        <div class="banner_img">
                            <div class="img wow fadeInUp">
                                <img src="{{ $hero && $hero->image ? asset($hero->image) : asset('website/images/banner_img.png') }}"
                    ...
                    @forelse($menuCategories as $category)
                        <div class="col-xl-3 wow fadeInUp">
                            <a href="{{ route('website.menu', ['category' => $category->slug]) }}" class="category_item">
                                <img src="{{ $category->image ? asset($category->image) : asset('website/images/category_img_1.jpg') }}"
                    ...
                    @empty
                        <div class="col-xl-3 wow fadeInUp">
                            <a href="{{ route('website.menu') }}" class="category_item">
                                <img src="{{ asset('website/images/category_img_1.jpg') }}" alt="category"
                        ...
                        <div class="col-xl-8 col-lg-7 wow fadeInLeft">
                            <div class="add_banner_large"
                                ...
                                <div class="text">
                                    ...
                                    <a href="{{ $adLarge->button_link ?? route('website.menu') }}">{{ $adLarge->button_text ?? 'Order Now' }}
                        ...
                        <div class="col-xl-4 col-lg-5 wow fadeInRight">
                            <div class="add_banner_small"
                                ...
                                <div class="text">
                                    ...
                                    <a href="{{ $adSmall->button_link ?? route('website.menu') }}">{{ $adSmall->button_text ?? 'Order Now' }}
                                        <i class="fas fa-chevron-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="schedule">
                        <div class="colorful-tab-wrapper" id="filter_area">
                                    ...
                                    <ul class="filter_btn_area">
                                        @foreach ($menuCategoriesWithItems as $index => $cat)
                                            <li class="{{ $index === 0 ? 'active' : '' }}"><a
                                                    href="#category_{{ $cat->id }}">{{ strtoupper($cat->name) }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    @foreach ($menuCategoriesWithItems as $index => $cat)
                                        <div class="colorful-tab-content {{ $index === 0 ? 'active' : '' }}"
                                            id="category_{{ $cat->id }}">
                                            <div class="row">
                                                    ...
                                                    <div class="col-xl-3 col-sm-6 col-lg-4 wow fadeInUp">
                                                        <div class="single_menu">
                                                            <div class="single_menu_img">
                                                                ...
                                                                <ul>
                                                                    <li><a
                                                                            href="{{ route('website.menu-details', $item->slug) }}"><i
                                                                                class="far fa-eye"></i></a></li>
                                                                    <li><a href="#" class="favorite-btn"
                                                            ...
                                                            <div class="single_menu_text">
                                                                ...
                                                                <a class="category"
                                                                    href="{{ route('website.menu', ['category' => $cat->slug]) }}">{{ $cat->name }}</a>
                                                                <a class="title"
                                                                    href="{{ route('website.menu-details', $item->slug) }}">{{ $item->name }}</a>
                                                                <p class="descrption">
                                                                    {{ Str::limit(strip_tags($item->short_description), 40) }}
                                                                </p>
                                                                <div
                                                                    class="d-flex flex-wrap align-items-center justify-content-between">
                                                                    <div class="price-wrapper">
                                                                        @if ($item->discount_price && $item->discount_price < $item->base_price)
                                                                            <h3>{{ currency($item->final_price) }}</h3>
                                ...
                                <div class="single_menu">
                                    <div class="single_menu_img">
                                        <img src="{{ $item->image_url }}" alt="{{ $item->name }}"
                                            class="img-fluid w-100">
                                        <ul>
                                            <li><a href="{{ route('website.menu-details', $item->slug) }}"><i
                                                        class="far fa-eye"></i></a></li>
                                            <li><a href="#" class="favorite-btn"
                                                    data-item-id="{{ $item->id }}"><i class="far fa-heart"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="single_menu_text">
                                        ...
                                        @if ($item->category)
                                            <a class="category"
                                                href="{{ route('website.menu', ['category' => $item->category->slug]) }}">{{ $item->category->name }}</a>
                                        @endif
                                        <a class="title"
                                            href="{{ route('website.menu-details', $item->slug) }}">{{ $item->name }}</a>
                                        <p class="descrption">{{ Str::limit(strip_tags($item->short_description), 40) }}
                                        </p>
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            <div class="price-wrapper">
                                                @if ($item->discount_price && $item->discount_price < $item->base_price)
                                                    <span
                                                        style="text-decoration: line-through; color: #999; font-size: 13px; display: block;">{{ currency($item->base_price) }}</span>
                ...
                <div class="row">
                    <div class="col-xl-5 col-md-6">
                        <div class="add_banner_full_text wow fadeInLeft">
                            ...
                            <div class="img">
                                <img src="{{ $specialOffer && $specialOffer->image ? asset($specialOffer->image) : asset('website/images/add_banner_full_img.png') }}"
                                    alt="add banner" class="img-fluid w-100">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-xxl-5 col-md-6 col-lg-5 wow fadeInLeft">
                        <div class="app_download_img">
                            <img src="{{ $appDownload && $appDownload->image ? asset($appDownload->image) : asset('website/images/download_img.png') }}"
                                alt="download" class="img-fluid w-100">
                        </div>
                    </div>
                    <div class="col-xxl-5 col-md-6 col-lg-6 wow fadeInRight">
                        <div class="app_download_text">
                            <h2 class="wow bounceIn">{{ $appDownload->title ?? 'Are you Ready to Start your Order?' }}
                            </h2>
                            <p>{{ $appDownload->description ?? 'Download our app and enjoy exclusive offers, easy ordering, and fast delivery.' }}
                            </p>
                            @php
    ...
    @if (!$testimonialSection || $testimonialSection->section_status)
        <!--==========TESTIMONIAL START===========-->
        <section class="testimonial mt_140 xs_mt_100"
            style="background: url({{ $testimonialSection && $testimonialSection->background_image ? asset($testimonialSection->background_image) : asset('website/images/testimonial_bg.jpg') }});">
                    ...
                    <div class="row">
                                    ...
                                    @empty
                                        <div class="col-12">
                                            <div class="single_testimonial">
                                                ...
                                                <p class="description">
                                                    "{{ __('Great food and excellent service! Highly recommended.') }}"</p>
                                                <div class="single_testimonial_footer">
                                                    <div class="img">
                                                        <img src="{{ asset('website/images/client_img_1.png') }}"
                                                            alt="{{ __('Customer') }}" class="img-fluid w-100">
                                                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="testimonial_video">
                                @php
                                    $videoUrl =
                                        $testimonialSection->video ?? 'https://www.youtube.com/watch?v=dQw4w9WgXcQ';
                        ...
                        <div class="col-lg-4 col-sm-6 wow fadeInUp">
                            <div class="single_blog">
                                ...
                                <div class="single_blog_text">
                                    ...
                                    <a class="read_btn" href="{{ route('website.blog-details', $blog->slug) }}">Read
