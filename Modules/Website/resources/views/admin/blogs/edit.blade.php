...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card mb-3 page-title-card">
        <div class="card-header d-flex justify-content-between">
            <h4 class="section_title">{{ __('Edit Blog') }}</h4>
            <a href="{{ route('admin.restaurant.blogs.index') }}" class="btn btn-primary">
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        @if($blog->image)
                            <div class="mb-3">
                                <img src="{{ $blog->image_url }}" alt="{{ $blog->title }}" class="img-fluid rounded" style="max-height: 200px;">
                            </div>
                        @endif
