...
@section('title', __('Add Catering Package'))

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-0">{{ __('Add Catering Package') }}</h4>
    ...
    <form action="{{ route('admin.restaurant.catering.packages.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" placeholder="{{ __('Leave empty to auto-generate') }}">
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="min_guests" class="form-control @error('min_guests') is-invalid @enderror" value="{{ old('min_guests', 10) }}" min="1" required>
                                @error('min_guests')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="max_guests" class="form-control @error('max_guests') is-invalid @enderror" value="{{ old('max_guests', 100) }}" min="1" required>
                                @error('max_guests')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="bx bx-save me-1"></i>{{ __('Save Package') }}
                        </button>
                    </div>
                </div>
            </div>
