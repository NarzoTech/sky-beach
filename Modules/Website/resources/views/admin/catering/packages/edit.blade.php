                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="long_description" class="form-control summernote @error('long_description') is-invalid @enderror" rows="5">{{ old('long_description', $package->long_description) }}</textarea>
