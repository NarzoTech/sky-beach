                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Select to subscribe to our newsletter and updates and we will send
                                                    you
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp">
                            <div class="contact_info">
                                ...
                                <div class="text">
                                    ...
                                    <a href="mailto:support@CTAKEgmail.com">support@CTAKEgmail.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
