                    ...
                    <div class="col-lg-8 wow fadeInLeft">
                        ...
                        <div class="service_details_text">
                            ...
                            @if($service->description)
                                {!! $service->description !!}
                            @else
                                <p>{{ __('No detailed description available for this service.') }}</p>
                            @endif
                        </div>
                    ...
                    <div class="col-lg-4 col-md-8 wow fadeInRight">
                        <div class="blog_sidebar">
                            ...
                            <div class="sidebar_wizard contact_sidebar mb-4">
                                <h2>{{ __('Inquire About This Service') }}</h2>
                                @if(session('success'))
                            ...
                            <div class="sidebar_banner menu_details_banner mt_25">
                                <img src="{{ asset('website/images/offer_bg.jpg') }}" alt="{{ __('offer') }}" class="img-fluid w-100">
                                <div class="text">
