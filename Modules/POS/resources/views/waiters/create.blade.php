...
@section('content')
    <div class="main-content">
        <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h3 class="page-title mb-0">
                            <i class="fas fa-user-plus me-2"></i>{{ __('Add New Waiter') }}
                        </h3>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.pos.waiters.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="name" id="name"
                                               ...
                                               value="{{ old('name') }}" required placeholder="{{ __('Enter waiter name') }}">
                                        @error('name')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="mobile" id="mobile"
                                               ...
                                               value="{{ old('mobile') }}" required placeholder="{{ __('Enter mobile number') }}">
                                        @error('mobile')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="designation" id="designation"
                                               ...
                                               value="{{ old('designation', 'Waiter') }}" placeholder="{{ __('e.g., Senior Waiter, Head Waiter') }}">
                                        @error('designation')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nid" id="nid"
                                               ...
                                               value="{{ old('nid') }}" placeholder="{{ __('Enter ID number') }}">
                                        @error('nid')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="yearly_leaves" id="yearly_leaves"
                                               ...
                                               value="{{ old('yearly_leaves', 12) }}" placeholder="12">
                                        @error('yearly_leaves')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>{{ __('Save Waiter') }}
                            </button>
                        </div>
                    </form>
                </div>
