                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4 class="section_title">{{ __('Edit Menu Category') }}</h4>
                                <div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="display_order" class="form-control"
                                                            id="display_order" value="{{ old('display_order', $category->display_order) }}" min="0">
                                                        @error('display_order')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="is_featured" id="is_featured" class="form-control">
                                                            <option value="0" {{ old('is_featured', $category->is_featured) == 0 ? 'selected' : '' }}>
                                                                {{ __('No') }}
                                                            </option>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="is_popular" id="is_popular" class="form-control">
                                                            <option value="0" {{ old('is_popular', $category->is_popular) == 0 ? 'selected' : '' }}>
                                                                {{ __('No') }}
                                                            </option>
                                                            <option value="1" {{ old('is_popular', $category->is_popular) == 1 ? 'selected' : '' }}>
                                                                {{ __('Yes') }}
                                                            </option>
                                                        </select>
                                                        @error('is_popular')
