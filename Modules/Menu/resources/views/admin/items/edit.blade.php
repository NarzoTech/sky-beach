            ...
            <div class="section-body">
                <div class="card mb-3 page-title-card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="section_title">{{ __('Edit Menu Item') }}: {{ $item->name }}</h4>
                        <a href="{{ route('admin.menu-item.index') }}" class="btn btn-primary">
                            <i class="fa fa-arrow-left"></i> {{ __('Back') }}
                        </a>
                    </div>
                </div>
                <form action="{{ route('admin.menu-item.update', $item->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                    <div class="row">
                                        <!-- Basic Information -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="name" class="form-control" id="name" required value="{{ old('name', $item->name) }}">
                                                                @error('name')
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="slug" class="form-control" id="slug" value="{{ old('slug', $item->slug) }}">
                                                                @error('slug')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="menu_serial" class="form-control" id="menu_serial" value="{{ old('menu_serial', $item->menu_serial) }}">
                                                                @error('menu_serial')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="short_description" class="form-control" id="short_description" rows="2">{{ old('short_description', $item->short_description) }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="long_description">{{ __('Full Description') }}</label>
                                                                <textarea name="long_description" class="form-control summernote" id="long_description" rows="4">{{ old('long_description', $item->long_description) }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="calories" class="form-control" id="calories" value="{{ old('calories', $item->calories) }}" min="0">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="is_vegetarian" id="is_vegetarian" class="form-control">
                                                                    <option value="0" {{ old('is_vegetarian', $item->is_vegetarian) == 0 ? 'selected' : '' }}>{{ __('No') }}</option>
                                                                    <option value="1" {{ old('is_vegetarian', $item->is_vegetarian) == 1 ? 'selected' : '' }}>{{ __('Yes') }}</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="is_vegan" id="is_vegan" class="form-control">
                                                                    <option value="0" {{ old('is_vegan', $item->is_vegan) == 0 ? 'selected' : '' }}>{{ __('No') }}</option>
                                                                    <option value="1" {{ old('is_vegan', $item->is_vegan) == 1 ? 'selected' : '' }}>{{ __('Yes') }}</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="is_spicy" id="is_spicy" class="form-control">
                                                                    <option value="0" {{ old('is_spicy', $item->is_spicy) == 0 ? 'selected' : '' }}>{{ __('No') }}</option>
                                                                    <option value="1" {{ old('is_spicy', $item->is_spicy) == 1 ? 'selected' : '' }}>{{ __('Yes') }}</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="spice_level" class="form-control" id="spice_level" value="{{ old('spice_level', $item->spice_level) }}" min="0" max="5">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="allergens[]" id="allergens" class="form-control select2" multiple>
                                                                    @foreach ($allergenOptions as $key => $label)
                                                                        <option value="{{ $key }}" {{ in_array($key, old('allergens', $item->allergens ?? [])) ? 'selected' : '' }}>
                                                                            {{ $label }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                        ...
                                        <div class="col-lg-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" id="status" class="form-control">
                                                            <option value="1" {{ old('status', $item->status) == 1 ? 'selected' : '' }}>{{ __('Active') }}</option>
                                                            <option value="0" {{ old('status', $item->status) == 0 ? 'selected' : '' }}>{{ __('Inactive') }}</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="is_available">{{ __('Available') }}</label>
                                                        <select name="is_available" id="is_available" class="form-control">
                                                            <option value="1" {{ old('is_available', $item->is_available) == 1 ? 'selected' : '' }}>{{ __('Yes') }}</option>
                                            ...
                                            <div class="card mt-3">
                                                ...
                                                <div class="card-body">
                                                    <a href="{{ route('admin.menu-item.variants', $item->id) }}" class="btn btn-outline-primary btn-block mb-2">
                                                        <i class="fa fa-list"></i> {{ __('Manage Variants') }} ({{ $item->variants->count() }})
                                                    </a>
                                                    <a href="{{ route('admin.menu-item.addons', $item->id) }}" class="btn btn-outline-info btn-block mb-2">
                                                        <i class="fa fa-plus-circle"></i> {{ __('Manage Add-ons') }} ({{ $item->addons->count() }})
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card mt-3">
                                                <div class="card-body text-center">
                                                    <x-admin.save-button :text="__('Update Menu Item')"></x-admin.save-button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
