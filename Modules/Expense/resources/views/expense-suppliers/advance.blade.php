...
@section('title', __('Expense Supplier Advance Pay'))
@section('content')
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-header-title">
                                    <h4 class="section_title">{{ __('Expense Supplier Pay Advance') }}</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                ...
                                <form class="suppliers_adv_form"
                                    action="{{ route('admin.expense-suppliers.advance-store', $supplier->id) }}" method="POST">
                                    @csrf
                                    <div class="row mt-4">
                                        <div class="col-lg-6">
                                            <label for="note" class="">{{ __('Note') }}</label>
                                            <textarea name="note" class="form-control" placeholder="Note" id="note" rows="2"></textarea>
                                            <label for="memo" class="mt-2">{{ __('Memo') }}</label>
                                            <textarea name="memo" class="form-control" placeholder="Memo (optional)" id="memo" rows="2"></textarea>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="col-xl-6">
