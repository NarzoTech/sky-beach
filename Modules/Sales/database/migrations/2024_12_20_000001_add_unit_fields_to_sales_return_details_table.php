...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('sales_return_details', function (Blueprint $table) {
            if (!Schema::hasColumn('sales_return_details', 'menu_item_id')) {
                $table->unsignedBigInteger('menu_item_id')->nullable()->after('ingredient_id');
            }
            if (!Schema::hasColumn('sales_return_details', 'unit_id')) {
                $table->unsignedBigInteger('unit_id')->nullable()->after('service_id');
            }
            if (!Schema::hasColumn('sales_return_details', 'base_quantity')) {
