...
@section('title')
    {{ __('Service Page Sections') }}
@endsection

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0">{{ __('Manage Service Page Sections') }}</h4>
    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="list-group list-group-flush">
                    @php
                        $sectionLabels = [
                            'service_breadcrumb' => ['label' => 'Breadcrumb', 'icon' => 'bx-link'],
                            'service_list' => ['label' => 'Service List', 'icon' => 'bx-list-ul'],
                        ];
                    @endphp
                    @foreach($sections as $section)
                        ...
                        @endphp
                        <a href="{{ route('admin.cms.sections.edit', ['section' => $section, 'page' => 'service']) }}"
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.cms.sections.edit', ['section' => $activeSection, 'page' => 'service']) }}" class="btn btn-primary">
