...
@section('title')
    {{ __('Menu Page Sections') }}
@endsection

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0">{{ __('Manage Menu Page Sections') }}</h4>
    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="list-group list-group-flush">
                    @php
                        $sectionLabels = [
                            'menu_breadcrumb' => ['label' => 'Breadcrumb', 'icon' => 'bx-link'],
                            'menu_filters' => ['label' => 'Filters', 'icon' => 'bx-filter-alt'],
                        ];
                    @endphp
                    @foreach($sections as $section)
                        ...
                        @endphp
                        <a href="{{ route('admin.cms.sections.edit', ['section' => $section, 'page' => 'menu']) }}"
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.cms.sections.edit', ['section' => $activeSection, 'page' => 'menu']) }}" class="btn btn-primary">
