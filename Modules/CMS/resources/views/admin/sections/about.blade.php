...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0">{{ __('Manage About Page Sections') }}</h4>
    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="list-group list-group-flush">
                    @php
                        $sectionLabels = [
                            'about_breadcrumb' => ['label' => 'Breadcrumb', 'icon' => 'bx-link'],
                            'about_story' => ['label' => 'About Story', 'icon' => 'bx-book-open'],
                            'about_gallery' => ['label' => 'Gallery', 'icon' => 'bx-images'],
                            'about_showcase' => ['label' => 'Showcase', 'icon' => 'bx-grid-alt'],
                            'about_reservation' => ['label' => 'Reservation', 'icon' => 'bx-calendar'],
                            'about_testimonials' => ['label' => 'Testimonials', 'icon' => 'bx-message-square-dots'],
                            'about_counters' => ['label' => 'Counters', 'icon' => 'bx-bar-chart'],
                            'about_chefs' => ['label' => 'Chefs', 'icon' => 'bx-user'],
                            'about_blogs' => ['label' => 'Blogs', 'icon' => 'bx-news'],
                        ];
                    @endphp
                    @foreach($sections as $section)
                        ...
                        @endphp
                        <a href="{{ route('admin.cms.sections.edit', ['section' => $section, 'page' => 'about']) }}"
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.cms.sections.edit', ['section' => $activeSection, 'page' => 'about']) }}" class="btn btn-primary">
