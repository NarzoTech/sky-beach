...
@section('title')
    {{ __('Menu Detail Page Sections') }}
@endsection

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0">{{ __('Manage Menu Detail Page Sections') }}</h4>
    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="list-group list-group-flush">
                    @php
                        $sectionLabels = [
                            'menu_detail_featured_offer' => ['label' => 'Featured Offer', 'icon' => 'bx-gift'],
                            'menu_detail_sidebar_banner' => ['label' => 'Sidebar Banner', 'icon' => 'bx-image'],
                        ];
                    @endphp
                    @foreach($sections as $section)
                        ...
                        @endphp
                        <a href="{{ route('admin.cms.sections.edit', ['section' => $section, 'page' => 'menu_detail']) }}"
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.cms.sections.edit', ['section' => $activeSection, 'page' => 'menu_detail']) }}" class="btn btn-primary">
