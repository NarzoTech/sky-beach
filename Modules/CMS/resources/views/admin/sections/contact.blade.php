...
@section('title')
    {{ __('Contact Page Sections') }}
@endsection

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0">{{ __('Manage Contact Page Sections') }}</h4>
    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="list-group list-group-flush">
                    @php
                        $sectionLabels = [
                            'contact_breadcrumb' => ['label' => 'Breadcrumb', 'icon' => 'bx-link'],
                            'contact_form' => ['label' => 'Contact Form', 'icon' => 'bx-envelope'],
                            'contact_info' => ['label' => 'Contact Info', 'icon' => 'bx-info-circle'],
                            'contact_map' => ['label' => 'Map', 'icon' => 'bx-map'],
                        ];
                    @endphp
                    @foreach($sections as $section)
                        ...
                        @endphp
                        <a href="{{ route('admin.cms.sections.edit', ['section' => $section, 'page' => 'contact']) }}"
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.cms.sections.edit', ['section' => $activeSection, 'page' => 'contact']) }}" class="btn btn-primary">
