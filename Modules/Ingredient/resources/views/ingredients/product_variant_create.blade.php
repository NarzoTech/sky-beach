                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>{{ __('Add Product Variations') }}</h4>
                                <div>
                                        ...
                                        <div class="col-md-8 row offset-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="attribute" id="attribute" class="form-control select2"
                                                        multiple>
                    ...
                    $.each(selectedValues, function(index, combination) {
                        ...
                        variationTableHTML +=
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                <input type="text" class="form-control selling-price w-75" name="price[]" placeholder="Enter Selling Price" value="{{ $product->price }}">
                            </div>
                        </td>
                        <td >
                            <div class="d-flex justify-content-between align-items-center mt-3">
