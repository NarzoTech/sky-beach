...
use Modules\Ingredient\app\Http\Requests\AttributeRequest;
...
class IngredientAttributeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ingredient::ingredients.attributes.index', compact('attributes'));
    }
    ...
    {
        return view('ingredient::ingredients.attributes.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('ingredient::ingredients.attributes.edit', compact('attribute'));
    }
