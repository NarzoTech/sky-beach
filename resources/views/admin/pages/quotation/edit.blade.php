                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control datepicker" name="date"
                                                    value="{{ formatDate($quotation->date) }}" autocomplete="off" required>
                                                @error('date')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                    ...
                                                    <tbody id="quotation_table">
                                                        @foreach ($quotation->details as $index => $detail)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="number" class="form-control text-center item-qty" name="quantity[]"
                                                                        value="{{ $detail->quantity }}" min="1" required>
                                                                </td>
                                                                <td>
                                                                    <input type="number" class="form-control text-end item-price" name="unit_price[]"
                                                                        value="{{ $detail->price }}" min="0" step="0.01" required>
                                                                </td>
                                                                <td>
                                                                    <input type="number" class="form-control text-end item-total" name="total[]"
                                                                        value="{{ $detail->sub_total }}" readonly step="0.01">
                                                                </td>
                                                                <td class="text-center">
                                                                    <button type="button" class="btn btn-sm btn-outline-danger remove-row" {{ $loop->count == 1 ? 'disabled' : '' }}>
                                            ...
                                            <table class="table table-sm">
                                                <tr>
                                                    ...
                                                    <td class="border-0 text-end">
                                                        <input type="number" class="form-control form-control-sm text-end" name="subtotal" value="{{ $quotation->subtotal }}" readonly step="0.01">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border-0"><strong>{{ __('Discount') }}</strong></td>
                                                    <td class="border-0 text-end">
                                                        <input type="text" class="form-control form-control-sm text-end" name="discount" value="{{ $quotation->discount }}" placeholder="0 or 10%">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="border-0"><strong>{{ __('Tax/VAT') }}</strong></td>
                                                    <td class="border-0 text-end">
                                                        <input type="text" class="form-control form-control-sm text-end" name="vat" value="{{ $quotation->vat }}" placeholder="0 or 15%">
                                                    </td>
                                                </tr>
                                                <tr class="table-primary">
                                                    <td><strong class="fs-5">{{ __('Total') }}</strong></td>
                                                    <td class="text-end">
                                                        <input type="number" class="form-control form-control-sm text-end fw-bold fs-5" name="total_amount" value="{{ $quotation->total }}" readonly>
                                                        <input type="hidden" name="after_discount" value="{{ $quotation->after_discount }}">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="note" class="form-control" rows="3" placeholder="{{ __('Add any notes or terms for this quotation...') }}">{{ $quotation->note }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex justify-content-end gap-2">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="fas fa-save me-1"></i>{{ __('Update Quotation') }}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
